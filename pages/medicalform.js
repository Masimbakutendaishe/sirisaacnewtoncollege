...
const MedicalForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Error submitting the medical form. Please try again later.');
    }
  };
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative h-48 w-full bg-cover bg-center" style={{ backgroundImage: "url('/images/med.jpg')" }}>
        <div className="absolute inset-0 bg-black opacity-50"></div>
        <h1 className="relative text-left text-white text-5xl font-bold z-10 py-16">MEDICAL FORM</h1>
      </div>
      ...
      <div className="max-w-4xl mx-auto p-8">
        <form onSubmit={handleSubmit} className=" text-white rounded-lg shadow-lg p-6" style={{ backgroundColor: "hsla(32, 91%, 18%, 0.945)" }}>
          <h2 className="text-2xl font-bold mb-4">Please Fill Out the Medical Form</h2>
          ...
          <div className="mb-4">
            <label className="block text-white" htmlFor="medicalHistory">Medical History</label>
            <textarea
              id="medicalHistory"
              name="medicalHistory"
          ...
          <div className="mb-4">
            <label className="block text-white" htmlFor="allergies">Allergies</label>
            <input
              type="text"
              id="allergies"
              name="allergies"
          ...
          <div className="mb-4">
            <label className="block text-white" htmlFor="currentMedications">Current Medications</label>
            <input
              type="text"
          ...
          <button type="submit" className="bg-white text-blue-900 font-bold px-4 py-2 rounded">Submit Medical Form</button>
        </form>
      </div>
    </div>
  );
