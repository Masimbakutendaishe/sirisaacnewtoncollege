...
const Navbar = () => {
  return (
    <header className="flex flex-col justify-center items-center px-5 py-2.5 bg-white relative mr-10 md:flex-row md:items-center md:justify-between">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:gap-7">
        ...
        <nav>
          <ul className="relative grid grid-cols-2 md:flex md:flex-row md:gap-7 items-center m-0 font-bold">
